...
namespace Assets.SimpleSpriteTrails.Scripts
{
    ...
    public class MeleeWeaponTrail : MonoBehaviour
    {
        ...
        public void Build()
        {
            ...
            var trail = new Texture2D(texture.width * Scale.x, texture.height);
            ...
            var pivot = new Vector2(WeaponRenderer.sprite.pivot.x / (WeaponRenderer.sprite.rect.width*Scale.x), WeaponRenderer.sprite.pivot.y / WeaponRenderer.sprite.rect.height);

            GetComponent<SpriteRenderer>().sprite = Sprite.Create(trail, new Rect(0, 0, texture.width * Scale.x, texture.height), pivot, 100);
        }
