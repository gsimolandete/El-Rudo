    ...
    public class WizardPart : ScriptableWizard
    {
        ...
        protected void createPart()
        {
            try
            {
                ...
                Part tpart = _templates[_stemp] is WeaponTemplate ? EditorUtils.LoadScriptable<CharacterCreator2D.Weapon>(filename) :
                ...
                if (tpart is CharacterCreator2D.Weapon)
                {
                    WeaponTemplate twtemplate = (WeaponTemplate)_templates[_stemp];
                    CharacterCreator2D.Weapon tweapon = (CharacterCreator2D.Weapon)tpart;
